...
#line 2 "..\\ISP_FILE_ACCESS.c"
#line 3 "..\\ISP_FILE_ACCESS.c"
...
#line 4 "..\\ISP_FILE_ACCESS.c"
#line 1 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 45 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 74 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 95 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 114 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 414 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 502 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 531 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 612 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"
...
#line 866 "C:\\keil\\454\\ARM\\RV31\\Inc\\stdlib.h"


 
#line 5 "..\\ISP_FILE_ACCESS.c"
#line 1 "..\\ff8\\src\\ff.h"
...
unsigned int GET_FILE_SIZE(void *buf)
{
    ...
    res = f_open(&file1, (const char *)TempChar, 0x00 | 0x01);
...
unsigned int  f_ReadLine(int LineIDX, void *buf)
{
    ...
    uint8_t *TempChar;
    TempChar = (uint8_t *)buf;
    res = f_open(&file1, "0:\\DEFINE.txt", 0x00 | 0x01);

    if (res == FR_OK)
    {
        while (((((&file1)->fptr == (&file1)->fsize) ? 1 : 0) == 0))
        {
...
void Read_DATAFLASH_INFORMATION(void)
{
    ...
    if (str_result == 0)
    {
        ...
        f_ReadLine(5, (void *)DATAFLASH_NAME);
...
void Read_CONFIG_SDCARD(void)
{
    ...
    {
        w_Config = 1;
        f_ReadLine(11, (void *)SN_BUFF);
        w_Config0 = strtoul((const char *)SN_BUFF, 0, 0);
        sprintf((char *)Buff, "CONFIG0: 0x%x", w_Config0);
        printf("%s\n\r", Buff);

        f_ReadLine(12, (void *)SN_BUFF);
        w_Config1 = strtoul((const char *)SN_BUFF, 0, 0);
