...
void USBD_CtrlOut(void)
{
    ...
    if (g_usbd_CtrlOutToggle != (((USBD_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x80000UL))->EPSTS0 & 0xf0))
    {
        g_usbd_CtrlOutToggle = ((USBD_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x80000UL))->EPSTS0 & 0xf0;
