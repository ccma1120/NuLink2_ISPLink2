...
void UART_WriteMultiBytes(uint8_t *data)
{
    ...
    for (i = 0; i < (64); i++)
    {
        while ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->FIFOSTS & (0x1ul << (23))));

        ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->DAT = data[i];
    }

    while ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->FIFOSTS & (0x1ul << (28))) == 0);
...
ErrNo ISP_UART_READ(io_handle_t handle, void *buf, uint32 *len)
{
    ...
    {
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = 20000 * CyclesPerUs;
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL  = 0x0UL;
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = (1UL << 2U) | (1UL );
        ...
        while (bUartDataReady == 0)
        {
            ...
            if ((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL & (1UL << 16U)) != 0UL)
            {
                break;
            }
...
void UART2_IRQHandler(void)
{
    ...
    uint32_t u32IntSrc = ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->INTSTS;

    if (u32IntSrc & 0x11)   
    {
        while (((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->FIFOSTS & (0x1ul << (14))) == 0) && (bufhead < (64)))      
        {
            uart_rcvbuf[bufhead++] = ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->DAT;
        }
    }
...
ErrNo UART_Config(void *priv)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (0x1ul << (18));
     
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (~(0x3ul << (24)))) | (0x0UL << (24));
     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH & ~((0xful << (0)) | (0xful << (4))))
                    | ((0x07UL<<(0)) | (0x07UL<<(4)));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->FUNCSEL = (0x0ul << (0));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->LINE = (3ul) | (0x0ul << (3)) | (0x0ul << (2));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->FIFO = (0x3ul << (4)) | (0x3ul << (16));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | (((((12000000UL)) + ((115200)/2ul)) / (115200))-2ul));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->TOUT = (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->TOUT & ~(0xfful << (0))) | (0x40);
    NVIC_SetPriority(UART2_IRQn, 2);
    NVIC_EnableIRQ(UART2_IRQn);
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL))->INTEN = ((0x1ul << (11)) | (0x1ul << (4)) | (0x1ul << (0)));
