#line 1 "..\\HAL_Driver\\hal_hsusbd.c"
...
#line 2 "..\\HAL_Driver\\hal_hsusbd.c"
...
#line 3 "..\\HAL_Driver\\hal_hsusbd.c"
...
void _EP_HID_IN_Handler(uint32_t u32Ep, uint8_t *pu8Buf, uint32_t u32rLen)   
{
    ...
    for (i = 0; i < u32rLen; i++) {
        ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[u32Ep].EPDAT_BYTE = pu8Buf[i];
    }

    ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[u32Ep].EPTXCNT = 64;
    (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(u32Ep)]. EPINTEN = ((0x1ul << (6))));
}

void _EP_HID_OUT_Handler(uint32_t u32Ep, uint8_t *pu8Buf)   
{
    uint32_t len, i;
    len = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[u32Ep].EPDATCNT & 0xffff;

    for (i = 0; i < len; i++) {
        pu8Buf[i] = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[u32Ep].EPDAT_BYTE;
    }
}
