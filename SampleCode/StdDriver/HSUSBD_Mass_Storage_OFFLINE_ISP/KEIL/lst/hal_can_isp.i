#line 1 "..\\HAL_Driver\\hal_can_isp.c"
...
#line 2 "..\\HAL_Driver\\hal_can_isp.c"
...
#line 3 "..\\HAL_Driver\\hal_can_isp.c"
...
#line 10 "..\\HAL_Driver\\hal_can_isp.c"
...
void CAN_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (0x1ul << (25));
     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPH = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPH & ~((0xful << (4)) | (0xful << (8)))) |
                    ((0x09UL<<(4)) | (0x09UL<<(8)));
     
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->MODE = (((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->MODE & ~(0x3ul << (11 << 1))) | (0x1UL << (11 << 1));;
    (*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((11)<<2)))) = 0;
    CAN_SetBaudRate(((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL)), 500000);
    CAN_EnableInt(((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL)), ((0x1ul << (1)) | (0x1ul << (2)) | (0x1ul << (3))));
    NVIC_SetPriority(CAN1_IRQn, (1 << 4UL) - 2);
    NVIC_EnableIRQ(CAN1_IRQn);
     
    
    CAN_SetRxMsg(((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL)), (0), 0ul, 0x784);
}
...
void CAN1_IRQHandler(void)
{
    ...
    u8IIDRstatus = ((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL))->IIDR;

    if (u8IIDRstatus == 0x00008000) {      
         
         
         
        if (((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL))->STATUS & (0x1ul << (4))) {
            ((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL))->STATUS &= ~(0x1ul << (4));    
        }

        if (((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL))->STATUS & (0x1ul << (3))) {
            ((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL))->STATUS &= ~(0x1ul << (3));     
        }
    } else if (u8IIDRstatus != 0) {
        CAN_MsgInterrupt(((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL)), u8IIDRstatus);
        CAN_CLR_INT_PENDING_BIT(((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL)), (u8IIDRstatus - 1));  
    }
}
...
int32_t CAN_Package_Tx(CAN_T *tCAN, uint8_t *data)
{
    ...
    u8CAN_PackageFlag = 0;
    return CAN_Transmit(tCAN, (5), &tMsg);
}
...
void CAN_Transmit_ISP(uint32_t cmd, uint32_t data)
{
    ...
    buf[0] = cmd;
    buf[1] = data;
    CAN_Package_Tx(((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL)), (uint8_t *)buf);
}
...
void CAN_Test()
{
    ...
    CAN_Transmit_ISP(0xA2000000, 0x00300000UL);

    while (0 == u8CAN_PackageFlag);

    CAN_Transmit_ISP(0xA2000000, 0x00300004UL);

    while (0 == u8CAN_PackageFlag);

    CAN_Transmit_ISP(0xA2000000, 0x00300008UL);
