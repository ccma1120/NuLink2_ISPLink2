...
ErrNo CAN_WRITE(io_handle_t handle, const void *buf, uint32 *len)
{
    ...
    g_packno = (*((volatile unsigned int *)(pSrc + 4)));
    ...
    *((volatile unsigned int *)(response + 4)) = (++g_packno);
    ...
    if (glcmd == 0x000000A0)
    {
        ...
        {
            outdata = (*((volatile unsigned int *)(pSrc + i + 8)));
            ...
            {
                *((volatile unsigned short *)(response)) = (0);
    ...
    if (lcmd == 0x000000A0)
    {
        StartAddress = (*((volatile unsigned int *)(pSrc + 8)));
        TotalLen = (*((volatile unsigned int *)(pSrc + 12)));
        srclen = 64 - 16;
        ...
        for (i = 0; i < srclen; i = i + 4)
        {
            ...
            outdata = (*((volatile unsigned int *)(pSrc + i + 16)));
    ...
    if (lcmd == 0x000000B1)
    {
        ...
        *((volatile unsigned int *)(response + 8)) = (*(unsigned int *)&rrMsg . Data[4]);
    }
    ...
    if (lcmd == 0x000000A6)
    {
        *((volatile unsigned int *)(response + 8)) = (0xffffff5a);
    }

    if (lcmd == 0x000000CA)
    {
        *((volatile unsigned int *)(response + 8)) = (0X02);
    }

    if (lcmd == 0x000000A2)
    {
        CAN_Transmit_ISP(0xA2000000, 0x00300000);

        while (u8CAN_PackageFlag == 0);

        *((volatile unsigned int *)(response + 8)) = (*(unsigned int *)&rrMsg . Data[4]);

        CAN_Transmit_ISP(0xA2000000, 0x00300004);

        while (u8CAN_PackageFlag == 0);

        *((volatile unsigned int *)(response + 12)) = (*(unsigned int *)&rrMsg . Data[4]);

        CAN_Transmit_ISP(0xA2000000, 0x00300008);

        while (u8CAN_PackageFlag == 0);

        *((volatile unsigned int *)(response + 16)) = (*(unsigned int *)&rrMsg . Data[4]);

        CAN_Transmit_ISP(0xA2000000, 0x0030000C);

        while (u8CAN_PackageFlag == 0);

        *((volatile unsigned int *)(response + 20)) = (*(unsigned int *)&rrMsg . Data[4]);
    }
