...
void SPI1_Init(uint32_t Pclk0)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (0x1ul << (14));
     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL & ~((0xful << (0)) | (0xful << (4))))
                    | ((0x06UL<<(0)) | (0x06UL<<(4)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH & ~((0xful << (0)) | (0xful << (4))))
                    | ((0x06UL<<(0)) | (0x06UL<<(4)));
     
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->SMTEN |= (0x1ul << (8));
    ...
    ((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->I2SCTL &= ~(0x1ul << (0));
     
    ((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->SSCTL = (0x0U);
     
    ((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->CTL = (0x0U) | ((32 & 0x1F) << (8)) | (((0x1ul << (2)))) | (0x1ul << (0));
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL2 = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL2 & (~(0x3ul << (6)))) | (0x2UL << (6));
    ((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->CLKDIV = (((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->CLKDIV & (~(0x1fful << (0)))) | (u32Div << (0));
    ...
    ((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->FIFOCTL = (((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->FIFOCTL & ~((0x7ul << (28)) | (0x7ul << (24)))) |
                    (4 << (28)) |
                    (4 << (24));
    
    ((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->FIFOCTL |= ((0x1ul << (3)) | (0x1ul << (4)));
    ...
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)), (0x00000010UL), 0x0UL);
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04140UL)), (0x00000800UL), 0x0UL);
}
...
uint32_t SPI1_Write(uint32_t *buf, uint32_t len)
{
    ...
    *buf = (*buf | 0x53504900);
    ((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))->SSCTL |= (0x1ul << (0));
    u32TxDataCount = 0;
    u32RxDataCount = 0;
    ...
    while ((u32RxDataCount < len) || (u32TxDataCount < len)) {
        ...
        if (((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->STATUS & (0x1ul << (17)))>>(17)) == 0) && (u32TxDataCount < len)) {
             
            ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->TX = (buf[u32TxDataCount++]));
        }

         
        if (((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->STATUS & (0x1ul << (8)))>>(8)) == 0) && (u32RxDataCount < len)) {
             
            u32Dummy += ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->RX); 
            u32RxDataCount++;
        }
    }
...
uint32_t SPI1_Read(uint32_t *buf, uint32_t len)
{
    ...
    while ((u32RxDataCount < (len - 1)) || (u32TxDataCount < len)) {
        ...
        if (((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->STATUS & (0x1ul << (17)))>>(17)) == 0) && (u32TxDataCount < len)) {
            ...
            ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->TX = (u32TxDataCount++)); 
        }

         
        if (((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->STATUS & (0x1ul << (8)))>>(8)) == 0) && (u32RxDataCount < (len - 1))) {
            if (!u32Dummy) {
                u32Dummy = ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->RX);
                u32Dummy = 1;
            } else {
                 
                buf[u32RxDataCount++] = ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL)))->RX);
            }
        }
    }
