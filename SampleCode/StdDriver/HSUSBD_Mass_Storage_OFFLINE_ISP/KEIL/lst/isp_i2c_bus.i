...
#line 6 "..\\ISP_I2C_BUS.C"


ErrNo I2C_WRITE(io_handle_t handle, const void *buf, uint32 *len)
{
    UI2C_WriteMultiBytes(((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)), 0x60, (uint8_t *)buf, 64);
    return 0;
}

ErrNo I2C_READ(io_handle_t handle, void *buf, uint32 *len)
{
    UI2C_ReadMultiBytes(((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)), 0x60, (uint8_t *)buf, 64);
    return 0;
}
