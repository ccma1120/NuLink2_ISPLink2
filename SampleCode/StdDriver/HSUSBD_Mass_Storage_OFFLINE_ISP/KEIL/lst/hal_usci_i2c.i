#line 1 "..\\HAL_Driver\\hal_usci_i2c.c"
...
#line 2 "..\\HAL_Driver\\hal_usci_i2c.c"
...
void UI2C0_Init(uint32_t Pclk0, uint32_t u32BusClock)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK1 |= (0x1ul << (8));
     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL & ~((0xful << (8)) | (0xful << (12)))) |
                    ((0x07UL<<(8)) | (0x07UL<<(12)));
     
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL))->SMTEN |= (0x1ul << (2));
     
    
    u32ClkDiv = (uint32_t)((((((u32Pclk / 2U) * 10U) / (u32BusClock)) + 5U) / 10U) - 1U);  
     
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->CTL &= ~(0x7ul << (0));
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->CTL = 4U << (0);
     
     
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->LINECTL &= ~(0xful << (8));
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->LINECTL |= 8U << (8);
     
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->LINECTL &= ~(0x1ul << (0));
     
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->BRGEN &= ~(0x3fful << (16));
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->BRGEN |= (u32ClkDiv << (16));
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->PROTCTL |=  (0x1ul << (31));
     
    
     
    
    ((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->PROTCTL  = (((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->PROTCTL & ~(0x1ul << (0))) | (0U);
