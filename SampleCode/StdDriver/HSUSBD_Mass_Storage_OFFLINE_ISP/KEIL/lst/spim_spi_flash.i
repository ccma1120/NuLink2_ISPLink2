...
#line 12 "..\\SPIM_SPI_FLASH.c"




uint32_t g_sectorBuf[1024];  
...
void SpiInit(void)
{
    ...
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->SLEWCTL = (((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->SLEWCTL & 0xFFFFF000) |
                  ...
                  (0x1 << (4)) | (0x1 << (6)) |
                  (0x1 << (8)) | (0x1 << (10));
    do { ((volatile SPIM_T *) (0x40007000UL))->CTL1 = (((volatile SPIM_T *) (0x40007000UL))->CTL1 & (~(0xfffful << (16)))) | ((1) << (16)); } while (0);         
...
void WINBOND25X16A_EraseSector(uint32_t u32StartSector)
{
    ...
    SPIM_EraseBlock(u32StartAddr, 0, 0x20U, 1, 1);
}
...
int32_t WINBOND25X16A_ProgramPage(uint32_t u32StartPage, uint8_t *pu8Data)
{
    ...
    SPIM_IO_Write(u32StartAddr, 0, 256, pu8Data, 0x02U, 1, 1, 1);
    return 0;
}
...
)
{
    uint32_t u32StartAddr;
    u32StartAddr = u32StartPage & 0x0FFFFF00;
    SPIM_IO_Read(u32StartAddr, 0, 256, pu8Data, 0x0bU, 1, 1, 1, 1);
    return 0;
    ...
    else
    {
        do
        {
            ...
            if (offset || (size < 4096))
            {
                ...
                SpiRead(alignAddr, 4096, (uint32_t)&g_sectorBuf[0]);
            }
