...
static volatile uint8_t g_lib_IspModule = 0ul; 
...
{
    _EP_HID_IN_Handler(0ul, g_lib_AckBuf, 64);
}

void ISP_Bridge_UsbDataOut()
{
    _EP_HID_OUT_Handler(1ul, g_lib_CmdBuf);
    g_lib_CmdFromTool = (1UL);
}

void ISP_Bridge_Init(void)
{
    uint32_t Pclk0 = 192000000UL / 2;
    SPI1_Init(Pclk0);
...
void ISP_Bridge_Main(void)
{
    ...
    if (g_lib_CmdFromTool == (1UL))
    {
        g_lib_CmdFromTool = (0UL);
        cmd = g_lib_CmdBuf[0];
        ...
        switch (g_lib_IspModule)
        {
            ...
            case 4:
                ...
                if (64 == UI2C_WriteMultiBytes(((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)), 0x60, g_lib_CmdBuf, 64))
                {
                    g_lib_CmdToTarget = 1;
                }
                else
            ...
            case 6:
                ;
                CAN_Package_Tx(((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL)), g_lib_CmdBuf + 2);
                ;
                g_lib_CmdToTarget = 0;
                return;
    ...
    if (g_lib_CmdToTarget && (g_lib_CmdFromTool == (0UL)))
    {
        ...
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = delay * _CyclesPerUs;
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL  = 0x0UL;
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = (1UL << 2U) | (1UL );

        while (g_lib_CmdFromTool == (0UL))
        {
            if (((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL & (1UL << 16U))
            {
                ...
                switch (g_lib_IspModule)
                {
                    ...
                    case 4:
                    default:
                        u32rxLen = UI2C_ReadMultiBytes(((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)), 0x60, g_lib_AckBuf, 64);
                        break;
                }

                if ((u32rxLen == 64) && cks == (*((volatile unsigned int *)(g_lib_AckBuf))))
                {
