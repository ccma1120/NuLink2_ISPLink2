...
void TIMER3_Test(void)
{
    ...
    while (1) {
        if (((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL))->INTSTS & (0x1ul << (0))) {
            
            TIMER_ClearIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL)));
            printf("%d sec\n", sec++);
        }
    }
}
...
void TIMER3_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (0x1ul << (5));
     
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (~(0x7ul << (20)))) | (0x0UL << (20));
    
    
    TIMER_Open(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL)), (1UL << (27)), 1);
    
    TIMER_EnableInt(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL)));
    
    
    TIMER_Start(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL)));
