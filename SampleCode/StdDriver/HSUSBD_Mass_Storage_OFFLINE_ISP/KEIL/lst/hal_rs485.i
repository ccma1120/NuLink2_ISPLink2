...
#line 1 "..\\HAL_Driver\\hal_api.h"
#line 2 "..\\HAL_Driver\\hal_api.h"
#line 3 "..\\HAL_Driver\\hal_api.h"
...
#line 17 "..\\HAL_Driver\\hal_api.h"





extern uint32_t _CyclesPerUs;          



void _EP_HID_IN_Handler(uint32_t u32Ep, uint8_t *pu8Buf, uint32_t u32rLen);   
void _EP_HID_OUT_Handler(uint32_t u32Ep, uint8_t *pu8Buf);   
...
#line 10 "..\\HAL_Driver\\hal_rs485.c"
...
void RS485_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (0x1ul << (17));
     
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 &= ~(0x3ul << (26));
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 |= (0x3UL << (26));
    
    
    
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL))->MODE = (((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL))->MODE & ~(0x3ul << (12 << 1))) | (0x1UL << (12 << 1));
    ((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(4))) + ((12)<<2))))) = (0);
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPH = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPH & ~((0xful << (0)))) | (0x08UL<<(0));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH & ~((0xful << (20)))) | (0x08UL<<(20));
     
     
     
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FUNCSEL = (0x0ul << (0));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->LINE = (3ul) | (0x0ul << (3)) | (0x0ul << (2));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FIFO = (0x3ul << (4)) | (0x3ul << (16));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | (((((12000000UL)) + ((115200)/2ul)) / (115200))-2ul));
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->TOUT = (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->TOUT & ~(0xfful << (0))) | (0x40);
    NVIC_SetPriority(UART1_IRQn, 2);
    NVIC_EnableIRQ(UART1_IRQn);
     
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->INTEN = ((0x1ul << (11)) | (0x1ul << (4)) | (0x1ul << (0)));
}
...
void UART1_IRQHandler(void)
{
    ...
    uint32_t u32IntSrc = ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->INTSTS;

    if (u32IntSrc & 0x11) { 
        while (((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FIFOSTS & (0x1ul << (14))) == 0) && (bufhead < (64))) {	
            uart_rcvbuf[bufhead++] = ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->DAT;
        }
    }
...
void RS485_WriteMultiBytes(uint8_t *data)
{
    ...
    bUartDataReady = 0;
    ((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(4))) + ((12)<<2))))) = (1);
    ...
    while ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FIFOSTS & (0x1ul << (28))) == 0);
