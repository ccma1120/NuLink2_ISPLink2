...
void ISP_Bridge_UsbDataOut(void);
...
void SYS_Init(void)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->USBPHY &= ~(0x3ul << (16));     
     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->USBPHY = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->USBPHY & ~((0x3ul << (16)) | (0x1ul << (25)))) | (0x1ul << (24));

    for (i = 0; i < 0x1000; i++);  

    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->USBPHY |= (0x1ul << (25));

     
    CLK_EnableModuleClock(((0UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(10UL<<0)));
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |= ((0x07UL<<(0)) | (0x07UL<<(4)));
...
void ISP_FLOW(void)
{
    ...
    if (Read_ARPOM_INFORMATION() == 0)
    {
        ...
        if (DEVICE_TYPE == I2C_BUS)
            ret = io_open("I2C0", &DEV_handle);

        if (DEVICE_TYPE == RS485_BUS)
            ret = io_open("RS4850", &DEV_handle);

        if (DEVICE_TYPE == SPI_BUS)
            ret = io_open("SPI0", &DEV_handle);

        if (DEVICE_TYPE == UART_BUS)
            ret = io_open("UART0", &DEV_handle);
...
void GPC_IRQHandler(void)
{
    ...
    if (((((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)))->INTSRC & ((0x00000080UL))))
    {
        ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)))->INTSRC = ((0x00000080UL)));
    }
}
...
int32_t main(void)
{
    ...
    HSUSBD_Open(&gsHSInfo, MSC_ClassRequest, 0);

     
    MSC_Init();
    (((GPIO_DBCTL_T *) (((uint32_t)0x40000000) + 0x04440UL))->DBCTL = ((1ul << (5)) | (0x00000010UL) | (0x0000000AUL)));
    ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)))->DBEN |= ((0x00000080UL)));
     
    NVIC_EnableIRQ(USBD20_IRQn);
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000080UL), 0x0UL);
    GPIO_EnableInt(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), 7, 0x00000001UL);
    ...
    while (1)
    {
        ...
        if ((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((7)<<2)))) == 0)
        {
